...
import org.lingg.redis.reentrantlock.io.lock.Lock;
import org.lingg.redis.reentrantlock.io.lock.example.IDGenerator;
...
public class IDGeneratorTest {
	...
	static final String HOST = "192.168.181.129";
	static final int PORT = 6379;
	static final String LOCK_KEY = "lock.lock";
	static final long LOCK_EXPIRE = 5 * 1000;
//	static final SocketAddress ADDR = new InetSocketAddress("192.168.181.129", 9999);
