...
public class ZookeeperWatcher implements Watcher{
	...
	private String connection_add =
			"192.168.181.129:2181,192.168.181.129:2182,192.168.181.129:2183";
	/** 测试数据根路径  */
	 ...
	 * 	  zoo.exists(path, watch)  Or   zoo.exists(path, watcher)方法来判断节点是否存在，无论该节点是否存在都对该节点进行监控
