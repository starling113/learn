...
//        testConfig(conn);
    ...
    public List<Pair<Integer, Integer>> getCounter(Jedis conn, String name, int precision) {
        ...
        Comparator<Pair<Integer, Integer>> comparatorPair = (o1, o2) -> {
            return COLLATOR.getCollationKey(String.valueOf(o1.getValue1())).compareTo(COLLATOR.getCollationKey(String.valueOf(o2.getValue1())));
        };

        Collections.sort(results, comparatorPair);
        return results;
    }
...
//                    continue;
//                }
                String cityId = next.get(0);
                String country = next.get(1);
                String region = next.get(2);
                String city = next.get(3);
